...
## 🎯 Цели на год
- [x] Улучшить React и TypeScript  
- [ ] Сделать 3 крупных open-source проекта  
- [ ] Изучить Next.js и SSR  
- [ ] Повысить навыки UI/UX дизайна
...
| Навык | Уровень |
|-------|---------|
| HTML | 90% ![bar](https://img.shields.io/badge/HTML-90%25-brightgreen) |
| CSS | 85% ![bar](https://img.shields.io/badge/CSS-85%25-brightgreen) |
| JavaScript | 80% ![bar](https://img.shields.io/badge/JS-80%25-yellow) |
| TypeScript | 75% ![bar](https://img.shields.io/badge/TS-75%25-yellow) |
| React | 85% ![bar](https://img.shields.io/badge/React-85%25-brightgreen) |
| Redux Toolkit | 80% ![bar](https://img.shields.io/badge/Redux-80%25-yellow) |
| Zustand | 70% ![bar](https://img.shields.io/badge/Zustand-70%25-orange) |
| Figma | 75% ![bar](https://img.shields.io/badge/Figma-75%25-yellow) |
